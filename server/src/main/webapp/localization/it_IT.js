...
document.localization ['it_IT'] = {
	...
	'error.configuration.file.empty.file': 'Inserisci un URL o carica un file',
	...
	'form.configuration.file.description': 'Descrizione file',
	...
	'form.settings.common.default.launcher': 'Launcher predefinito',
	...
	'table.heading.device.default.launcher': 'Imposta come predefinito',
	...
	'table.heading.file.name': 'Nome file',
	...
	'yes': 'sì',
	'no': 'no',
    "form.device.cedula": "Numero Identificativo",
    "form.device.cedula.placeholder": "Tra 5 e 11 cifre",
    "form.device.numeroCuotas": "Numero di rate",
    "form.device.cuotas.placeholder": "Tra 2 e 36",
    "form.device.plazoFinanciacion": "Termine di finanziamento",
    "form.device.plazo.seleccione": "Seleziona un termine",
    "form.device.plazo.quincenal": "Quindicinale",
    "form.device.plazo.mensual": "Mensile",
	"form.device.back": "Indietro",
	"form.device.next": "Continua",
	"form.device.currentStep": "Passo",
	"form.device.noqr": "Nessun codice QR per questo dispositivo. Controlla la configurazione associata",
	"form.device.lock": "Blocca",
	"form.device.unlock": "Sblocca",
	"form.device.step1": "Completa i dati per continuare il processo.",
	"form.device.step3": "Blocca o sblocca il dispositivo, secondo necessità.",

	'summary.avg.devices.by.company': 'Dispositivi registrati per azienda',
	'summary.enrolled.companies.count': 'Numero di negozi',
	'summary.operation.log.title': 'Registro delle operazioni'
};
