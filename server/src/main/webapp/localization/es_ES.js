...
document.localization ['es_ES'] = {
    ...
    'login.password.incorrect': 'Usuario o contraseña inválidos.',
    'login.password.recovery': '¿Olvidó su contraseña?',
    ...
    'signup.complete': '¡Gracias por registrarse!',
    ...
    'signup.first.name.placeholder': 'Primer nombre (requerido)',
    'signup.last.name': 'Apellido',
    'signup.last.name.placeholder': 'Apellido (requerido)',
    ...
    'devices.configuration.options.all': 'Todas las Configuraciones',
    ...
    'devices.file.lastUpdate.differs': '- ${file}: diferencia en tiempo de modificación de ${diff} minutos',

    'button.apply': 'Aplicar',
    'button.gps.on': 'Activar GPS',
    'button.wifi.on': 'Activar Wi-Fi',
    'button.notify.update': 'Notificar al actualizar',
    ...
    'button.common': 'Aplicación común',
    'button.close': 'Cerrar',
    'button.yes': 'Si',
    ...
    'question.delete.device': '¿Eliminar dispositivo con número "${deviceNumber}"?',
    ...
    'error.invalid.configuration.mainApp': 'En las opciones del MDM, se uso la aplicación incorrecta',
    'error.invalid.configuration.contentApp': 'Aplicación de contenido especificada inválida',
    ...
    'error.notfound.device': 'No se encontró dispositivo',
    ...
    'error.recent.application.version.exists': 'Ya existe una version superior de la aplicación',
    ...
    'error.application.config.reference.exists': 'La aplicación esta siendo usada en configuraciónes y no puede eliminarse',
    'error.application.version.deletion.prohibited': 'La versión es única o bien esta siendo usada en configuraciones y no puede eliminarse',
    ...
    'error.empty.app.iconText': 'Ingrese el texto del ícono',
    'error.empty.app.version': 'Ingrese la version de la aplicación',
    ...
    'error.params.missing': 'Parámetros faltantes:',
    ...
    'form.configuration.title.typical': 'Configuración típica',
    ...
    'form.configuration.settings.mdm.app.main': 'Aplicación MDM',
    ...
    'form.configuration.settings.mdm.component.server.url.placeholder': 'Usado para la migración a un nuevo servidor MDM',
    'form.configuration.settings.mdm.app.content': 'Aplicación de Contenido',
    'form.configuration.settings.mdm.kiosk.home': 'Habilitar Botón Inicio',
    'form.configuration.settings.mdm.kiosk.recents': 'Habilitar Botón Recientes',
    ...
    'form.configuration.apps.edit.details': 'Parámetros adicionales',
    'form.configuration.apps.keycode': 'Keycode',
    ...
    'form.configuration.settings.push.options.keepalive' : 'Tiempo para mantener vivo',
    ...
    'form.configuration.settings.password.mode.easy' : 'Facil (al menos 6 símbolos)',
    'form.configuration.settings.password.mode.moderate' : 'Moderada (8+ símbolos, letras y dígitos)',
    'form.configuration.settings.password.mode.strong' : 'Fuerte (8+, mayúsculas & minúsculas, dígitos, símbolos)',
    ...
    'form.configuration.file.description': 'Descripción archivo',
    ...
    'form.application.arch.warning': 'Este APK está optimizado solo para ${arch} y es posible que no funcione en todos los dispositivos. Se recomienda cargar otro APK optimizado para otra arquitectura de CPU. Para usar este APK en todos los dispositivos, seleccione "APK universal".',
    ...
    'form.application.run.after.install': 'Ejecutar después de la instalación',
    ...
    'form.application.run.at.boot': 'Ejecutar al inicio',
    'form.application.run.at.boot.title': 'Establezca esta opción si necesita ejecutar la aplicación en primer plano después del arranque. Esta bandera no afecta los procesos en segundo plano.',
    ...
    'form.file.apps.name': 'Nombre de Aplicación',
    ...
    'form.settings.common.battery.level': 'Nivel de Batería',
    ...
    'form.settings.design.color.app.names': 'Color de Nombre de Aplicaciones',
    ...
    'form.settings.misc.phone.format': 'Formato del número telefónico',
    ...
    'form.qr.code.image.alt': 'Código QR',
    ...
    'notfound.files':' La lista de archivos esta vacía',
    ...
    'app.description': 'es la solución MDM open-source',
    ...
    'qrcode.help.line1': 'Para configurar un dispositivo Android (version 7 or mayor) en un modo administrado:',
    ...
    'form.configuration.app.version.select.downgrade.warning': 'Bajar la versión ELIMINARÁ TODAS LAS APLICACIONES en todos los dispositivos. Bajar de la versión "${v1}" a la "${v2}"? ',

    'hint.step.1': 'Haz click aquí para comenzar el provisionamiento del dispositivo',
    'hint.step.2': 'Haz click aquí para mostrar el código QR',
    'hint.step.3': 'Haz click aquí para ingresar al lector QR del dispositivo',
    ...
    'tooltip.usage.byicons': 'Usada por íconos',

    'form.devices.label.params.more': 'Mas parámetros',
    'form.devices.label.params.less': 'Menos parámetros',
    ...
    'error.date.range.invalid': 'Rango de fechas inválido',

    'form.selection.status.any': 'Cualquier valor',
    ...
    'updates.auto.update': 'Actualiza automáticamente las aplicaciones móviles (¡utilícelo con cuidado en producción!)',
    ...
    'yes': 'si',
    'no': 'no',
    "form.device.cedula": "Cédula",
    "form.device.cedula.placeholder": "Entre 5 y 11 dígitos",
    "form.device.numeroCuotas": "Número de cuotas",
    "form.device.cuotas.placeholder": "Entre 2 y 36",
